...
|---|---|---|---|---|---|---|---|
| matrix | 92.16 | **0.997±0.001** | 1.000±0.000 | 1.000±0.000 | 0.997±0.000 | 0.997±0.000 | 0.999±0.000 |
| minor1 | 5.01 | **0.986±0.004** | 0.991±0.002 | 0.997±0.001 | 0.970±0.009 | 0.972±0.008 | 0.995±0.004 |
| minor2 | 1.98 | **0.979±0.016** | 0.992±0.006 | 0.992±0.005 | 0.960±0.019 | 0.971±0.010 | 0.970±0.019 |
| minor3 | 0.73 | **0.955±0.003** | 0.945±0.001 | 0.967±0.003 | 0.673±0.230 | 0.397±0.079 | 0.921±0.034 |
| minor4 | 0.24 | **0.862±0.022** | 0.977±0.011 | 0.979±0.014 | 0.187±0.098 | 0.120±0.007 | 0.876±0.046 |
| minor5 | 0.10 | **0.326±0.061** | 0.959±0.015 | 0.965±0.009 | 0.059±0.006 | 0.223±0.022 | 0.799±0.017 |

Minor-phase mean F1 — supervised: **PTEE 0.822**, SAM 0.973, LCF 0.980; unsupervised: PCA 0.570, SVD 0.537, PCA+cluster 0.912.

### Table 2 — detected area % (compare with the true area % — much larger = over-detection)

| phase | true area % | PTEE | SAM | LCF | PCA | SVD | PCA+cluster |
|---|---|---|---|---|---|---|---|
| matrix | 92.16 | 91.66 | 92.18 | 92.16 | 92.28 | 92.28 | 92.02 |
| minor1 | 5.01 | 4.88 | 4.96 | 5.00 | 4.80 | 4.83 | 4.97 |
| minor2 | 1.98 | 1.92 | 1.98 | 1.99 | 1.85 | 1.94 | 1.89 |
| minor3 | 0.73 | 0.74 | 0.73 | 0.73 | 1.46 | 2.11 | 0.67 |
| minor4 | 0.24 | 0.30 | 0.23 | 0.23 | 2.79 | 3.60 | 0.30 |
| minor5 | 0.10 | 0.51 | 0.10 | 0.10 | 2.91 | 0.08 | 0.15 |
...
- **PTEE** (all references, min–max R²): **69.7 ms**
- **SAM** (spectral-angle correlation, supervised): 151.1 ms
- **LCF** (non-negative linear-combination fit, supervised): 97.9 ms
- **PCA** (centered SVD): 609.0 ms
- **SVD** (uncentered): 616.9 ms
- **PCA+cluster** (PCA + k-means, the realistic workflow): 1688.2 ms
- The supervised target methods are all cheap closed-form passes: PTEE ≈ SAM (~70–151 ms), LCF 98 ms. PTEE is ~**8.7×** faster than a bare PCA/SVD decomposition and ~**24.2×** faster than the full PCA+cluster workflow, and scales more gently with pixel count (fig 3, right).
